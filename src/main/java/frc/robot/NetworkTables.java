...
public class NetworkTables {
    ...
    // Shooter
    public static double getShooterTargetRPM() {return shooterTargetRPM.getDouble(0);}
    public static double getLeftShooterP() {return leftShooterP.getDouble(0);}
    public static double getLeftShooterI() {return leftShooterI.getDouble(0);}
    public static double getLeftShooterD() {return leftShooterD.getDouble(0);}
    public static double getLeftShooterFF() {return leftShooterFF.getDouble(0);}
    public static double getLeftShooterRPM() {return leftShooterRPM.getDouble(0);}
    public static double getRightShooterP() {return leftShooterP.getDouble(0);}
    public static double getRightShooterI() {return leftShooterI.getDouble(0);}
    public static double getRightShooterD() {return leftShooterD.getDouble(0);}
    public static double getRightShooterFF() {return leftShooterFF.getDouble(0);}
    public static double getRightShooterRPM() {return leftShooterRPM.getDouble(0);}
    ...
    public static void setShooterTargetRPM(double RPM) {shooterTargetRPM.setDouble(RPM);}
    // Storage
    public static void setCorrectColor(String color) {correctColor.setString(color);}
    public static String getCorrectColor() {return correctColor.getString("");}

    public static String getColorReading() {return colorReading.getString("");}
    public static void setColorReading(String color) {colorReading.setString(color);}

    public static void setLineBroken(boolean broken) {lineBroken.setBoolean(broken);}
    public static boolean getLineBroken() {return lineBroken.getBoolean(false);}

    public static void setStorageRPM(double RPM) {storageRPM.setDouble(RPM);}
    // Shooter Arm
    public static void setShooterAngle(double angle) {shooterArmAngle.setDouble(angle);}
    public static double getShooterAngle() {return shooterArmAngle.getDouble(0);}
    public static void setShooterArmLocked(boolean locked) {shooterArmLocked.setBoolean(locked);}
    public static boolean getShooterLocked() {return shooterArmLocked.getBoolean(false);}
    // Pneumatics
    public static double getPressure(AnalogInput pressureInput) {return (50 * pressureInput.getVoltage()) - 25;}
    public static void setPressure(AnalogInput pressureInput) {pressure.setDouble((50 * pressureInput.getVoltage()) - 25);}
    // Intake
    public static void setIntakeRPM(double RPM) {intakeRPM.setDouble(RPM);}
    public static double getIntakeRPM() {return intakeRPM.getDouble(0);}
    public static void setIntakeDeployed(boolean deployed) {intakeDeployed.setBoolean(deployed);}
    public static boolean getIntakeDeployed() {return intakeDeployed.getBoolean(false);}
    // Winches
    public static void setLeftWinchHeight(double height) {leftWinchHeight.setDouble(height);}
    public static double getLeftWinchHeight() {return leftWinchHeight.getDouble(0);}
    public static void setLeftWinchLocked(boolean locked) {leftWinchLocked.setBoolean(locked);}
    public static boolean getLeftWinchLocked() {return rightWinchLocked.getBoolean(false);}
    public static void setRightWinchHeight(double height) {rightWinchHeight.setDouble(height);}
    public static double getRightWinchHeight() {return rightWinchHeight.getDouble(0);}
    public static void setRightWinchLocked(boolean locked) {rightWinchLocked.setBoolean(locked);}
    public static boolean getRightWinchLocked() {return rightWinchLocked.getBoolean(false);}
    // Telescoping Arms
    public static void setLeftTelescopingArmHeight(double height) {leftTelescopingArmHeight.setDouble(height);}
    public static double getLeftTelescopingArmHeight() {return leftTelescopingArmHeight.getDouble(0);}
    public static void setLeftTelescopingArmLocked(boolean locked) {leftTelescopingArmLocked.setBoolean(locked);}
    public static boolean getLeftTelescopingArmLocked() {return rightTelescopingArmLocked.getBoolean(false);}
    public static void setRightTelescopingArmHeight(double height) {rightTelescopingArmHeight.setDouble(height);}
    public static double getRightTelescopingArmHeight() {return rightTelescopingArmHeight.getDouble(0);}
    public static void setRightTelescopingArmLocked(boolean locked) {rightTelescopingArmLocked.setBoolean(locked);}
    public static boolean getRightTelescopingArmLocked() {return rightTelescopingArmLocked.getBoolean(false);}
}