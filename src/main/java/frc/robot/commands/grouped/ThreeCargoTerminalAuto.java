...
public class ThreeCargoTerminalAuto extends ParallelCommandGroup {
    ...
    public ThreeCargoTerminalAuto(Trajectories trajectories, Intake intake, IntakeFlipper intakeFlipper, Shooter shooter, ShooterArm shooterArm, Storage storage) {
