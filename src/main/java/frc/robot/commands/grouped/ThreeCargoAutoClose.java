...
public class ThreeCargoAutoClose extends ParallelCommandGroup {
    ...
    public ThreeCargoAutoClose(Trajectories trajectories, Intake intake, IntakeFlipper intakeFlipper, Shooter shooter, ShooterArm shooterArm, Storage storage) {
        ...
        upperTarmacToUpRightCargoDuration = upperTarmacToUpperCargoShotDuration + upperCargoShootDuration + 
            upperCargoShotToUpperFieldDuration + upperFieldToUpRightCargoDuration;
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                    new WaitCommand(upperTarmacToUpRightCargoDuration + intakeToStorageDuration + shooterArmLiftDuration - shooterSpinupDuration),
            ...
            new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                    new WaitCommand(upperTarmacToUpRightCargoDuration + intakeToStorageDuration),
                    new SetShooterArmAngle(shooterArm, highestShooterArmAngle)
                )
            ),
