...
public final class Tuning {
	...
	public static final double DRIVETRAIN_MAX_ACCEL = 3.8; // m/s^2
	...
	public static final double STATE_LEFT_DIST = 0.001;
	public static final double STATE_RIGHT_DIST = 0.001;
